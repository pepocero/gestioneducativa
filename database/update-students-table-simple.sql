-- Script simplificado para actualizar la tabla students
-- Evita problemas con restricciones existentes
...
-- 6. Agregar función para actualizar updated_at automáticamente
