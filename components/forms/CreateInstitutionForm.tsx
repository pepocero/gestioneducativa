...
export default function CreateInstitutionForm({ onClose, onSave }: CreateInstitutionFormProps) {
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Crea una nueva institución educativa</p>
              </div>
            </div>
